      ...
      if ($countdownTimer.length > 0) {
        ...
        $(".countdown").each(function (index, element) {
          ...
          elem.countdown(finalDate, function (event) {
            elem.html(event.strftime('<div class="countdown-container"><div class="countdown-box"><div class="number">%-D</div><span>Dni</span></div>' + '<div class="countdown-box"><div class="number">%H</div><span>Godzin</span></div>' + '<div class="countdown-box"><div class="number">%M</div><span>Minut</span></div>' + '<div class="countdown-box"><div class="number">%S</div><span>Sekund</span></div></div>'))
          });
        })
      }
    },
